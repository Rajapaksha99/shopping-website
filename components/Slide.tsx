...
const Slide: React.FC<PropsType> = ({ img, title, mainText, price }) => {
  return (
    <div className="outline-none border-none relative">
      ...
      <div className="absolute left-[30px] md:left-[70px] max-w-[250px] sm:max-w-[350px] top-[50%] -translate-y-[50%] space-y-2 lg:space-y-4 bg-white bg-opacity-90 p-4 rounded-lg shadow-md">
